...
const STEPS: { n: string; title: string; text: string; hint?: string }[] = [
  {
    ...
    text: "Жмите «Папка» и выбирайте ~/.config/eww — инструмент сам подтянет все .yuck и .scss внутри, определит корневые eww.yuck и eww.scss и разложит вложенные файлы по include-путям. Вручную вставить содержимое или «Импорт» отдельных файлов тоже работает.",
    hint: "ls ~/.config/eww",
  },
  {
    n: "02",
